...
- Brand the selector screen: the Coretastic wordmark, a firmware row per app with its mark, an inverted highlight on the selection, and countdown footer. Bitmaps are generated from the shipped artwork by `scripts/firmware/oled_brand.py`.
